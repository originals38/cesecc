...
<center>
<div> <table> <tr> <td> <div> <a class="button" href="index.php" style="float: right; border:1px solid; padding: 11px 21px; vertical-align: middle; background:red; color:black;border-radius:6px; font-size: 20px; font-family:helvetica, serif;text-decoration:none;">CRED CARD ADMIN</a> </div> </td> </tr> </table> </div>
...
<center>
       <button type="submit" name="x" class="btn btn-info "> CONFIRMAR <n> </button> 
</form>
